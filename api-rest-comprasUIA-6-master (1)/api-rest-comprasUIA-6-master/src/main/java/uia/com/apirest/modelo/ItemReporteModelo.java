...
public class ItemReporteModelo extends ItemComprasUIAModelo
{
    ...
    public ItemReporteModelo(int i, String name, int clasificacion, int id, String codigo, int existenciaMinima, int cantidad, double valorUnitario, double subtotal, double total)
    {
